...
const sitePath = /(["'`])\/(?=(?:basic|items|gacha|work|adventure|tavern|market|bestiary)(?:[\/"'`]|\\?["'`])|(?:shura-|kingdom-|system-icons|gacha-icons|roulette-|tavern-|market-|miru-|lilian-|nova-|elin-|hilda-|hostess-|favicon\.))/g;
...
async function rewrite(directory) {
  for (const entry of await readdir(directory, { withFileTypes: true })) {
    ...
    const quotedPathsPrefixed = source.replace(sitePath, (match, quote, offset) => {
