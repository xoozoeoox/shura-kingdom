...
const sitePath = /(["'`])\/(?=(?:basic|items|gacha|work|adventure|tavern|market|bestiary)(?:[\/"'`]|\\?["'`])|(?:shura-|kingdom-|system-icons|gacha-icons|roulette-|tavern-|miru-|lilian-|nova-|elin-|hilda-|hostess-|favicon\.))/g;
