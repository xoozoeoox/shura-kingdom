...
const events = [
  ...
  { rate: 3, title: "傳送陷阱", code: "WARP TRAP", text: "立即結束冒險，並隨機獲得 1～300 EXP。持有［反傳送指南針］時會自動消耗 1 個，使你免除傳送並重新選擇地圖；本次探險的增益效果會繼續保留，但已消耗的 AP 不會返還。" },
...
const itemDescriptions: Record<string, string> = {
  ...
  "［反傳送指南針］": "遇到《傳送陷阱》時會自動消耗 1 個，使你免除傳送並重新選擇地圖；本次探險的增益效果會繼續保留，但已消耗的 AP 不會返還。",
};
